...
var getSelectionRandomNum = function getSelectionRandomNum(num1, num2, num3, randomBegin, randomEnd) {
  ...
  var randomNum = _util["default"].getRandomNum(randomBegin, randomEnd);
  ...
  return new Promise(function (resolve, reject) {
    if (typeof window != 'undefined') {
      ...
      if (currentItem == undefined) {
        ...
        var operatorRandom = _util["default"].getRandomNum(0, 1);

        var num1 = _util["default"].getRandomNum(1, 20);

        var num2 = _util["default"].getRandomNum(1, 20);
        ...
        switch (numOperator) {
          case '+':
            ...
            selection = _lodash["default"].shuffle(selection);
            break;
...
serviceObj.getMathQuizItems = function () {
  return new Promise(function (resolve, reject) {
    if (typeof window != 'undefined') {
      ...
      var rightItems = _lodash["default"].filter(currentItems, function (o) {
        return o.isRight;
      });
